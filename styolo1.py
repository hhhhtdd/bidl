...
WINDOW_SIZE_SEC = 5.0
WINDOW_SIZE_POINTS_DS = int(WINDOW_SIZE_SEC * DOWNSAMPLED_SAMPLING_RATE_HZ)  # 500点
WINDOW_SIZE_POINTS_ORIGINAL = int(WINDOW_SIZE_SEC * ORIGINAL_SAMPLING_RATE_HZ)  # 5000点
